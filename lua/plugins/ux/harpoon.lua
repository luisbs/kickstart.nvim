...
local function nmap(keys, desc, func)
  vim.keymap.set('n', keys, func, { desc = 'Harpoon: ' .. desc, noremap = true, silent = true })
end
...
return {
  ...
  config = function()
    ...
    nmap('<A-l>', '[l]ist marked files', function() toggle_telescope_menu(tpicker, tfinder, tconf, harpoon:list()) end)
